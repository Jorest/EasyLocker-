...
public class PatternLockUtils {
    ...
    public PatternLockUtils PT = new PatternLockUtils();
    public ConfirmPatternActivity CP = new ConfirmPatternActivity();
    public SetPatternActivity SP = new SetPatternActivity();
